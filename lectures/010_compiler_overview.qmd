...
format:
  ...
  revealjs: 
    chalkboard: true
    output-file: "revealjs-compiler_overview.html"
    scrollable: true
---
...
1. writing clean, simple code
  a. no benefit to applying loop unrolling by hand
1. Encourage ADT’s that are as efficient as primitive types
1. Benefit: cleaner, higher level code gets written

The main problem with performance is how to chose the  algorithm 
