...
Kernel 0 - affine(unsigned short const*, unsigned short*): Total Grid Size Dims: (512, 512, 1) Workgroup Dims: (16, 16, 1) Kernel block count: (32, 32, 1).

# asta-hip

LD_PRELOAD=./examples/KernelArgumentIntrinsic/libKernelArgumentIntrinsic.so ./main

Kernel 0 - PTTWAC_soa_asta(int, int, int, float*, int*, int*): Total Grid Size Dims: (1024, 1, 1) Workgroup Dims: (64, 1, 1) Kernel block count: (16, 1, 1).
...
Kernel 338 - complex_float(char*, int): Total Grid Size Dims: (10000128, 1, 1) Workgroup Dims: (256, 1, 1) Kernel block count: (39063, 1, 1).
