...
You'll want to create a text file in the blog directory with your new post. Use a filename like YYYY-MM-DD-title.qmd, where the date is the discussion day or the project deadline and the title is up to you. 
 ...
 Each quarto file starts with some meta data. For example this file has 
...
If you want to use math in your blog post, you can use laytex dollar signs like `$\pi$` $\pi$ for inline math and `$$ e^{i\pi} + 1 = 0 $$`  $$ e^{i\pi} + 1 = 0 $$ for display math.
