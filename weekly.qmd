...
|---------|--------| ----| -----------|
|Sept  6  |[Compiler overview and structure](lectures/010_compiler_overview.qmd) |[hw0 needs 1 week](homework/hw0.qmd)
...
|         |        |     |            |
|---------|--------| ----| -----------|
Sept 17  |[Overview of Bril](lectures/02b_bril.qmd)                | hw0 due
...
|---------|--------| ----| -----------|
Oct 22  | papers 
Oct 25  | [GPU Compilers might need two classes](lectures/14_gpu_compilers.qmd)
...
|         |        |     |            |
|---------|--------| ----| -----------|
Dec 3    |  Interprocedural Analysis (could drop)
Dec 6    |  MLIR  (could drop)
